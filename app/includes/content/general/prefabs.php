<div id="content-swapper" class="container-fluid">
    <div class="row-fluid">
        <div class="col-lg-12">
            <h1 id="prefabs">Prefabs<sub class="sub-button">
            ...
            <?php if($user->isLoggedIn()): ?>
                ...
                <form target="upload-frame" id="uploadForm" name="uploadForm" class="form-horizontal" role="form" action="../app/parsers/create_file.php" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <input type="hidden" name="category" id="category" value="prefabs">
                        <div class="form-group field hide-me">
        ...
        <div id="pagination-top" class="col-lg-12">
            <nav>
                <ul class="pagination pagination-sm">
                    <?php $prefabs->pageInation('prefabs'); ?>
                </ul>
                    ...
                    <form action="" class="form-horizontal" style="margin-top: 20px;">
                        <div class="form-group field">
                            ...
                            <select class="pull-right" name="resNum" onchange="window.location.href= this.form.resNum.options[this.form.resNum.selectedIndex].value">
                                <option value="prefabs.php?page=1&amp;per-page=10">10</option>
                                <option value="prefabs.php?page=1&amp;per-page=20">20</option>
                                <option value="prefabs.php?page=1&amp;per-page=30">30</option>
                                <option value="prefabs.php?page=1&amp;per-page=40">40</option>
                                <option value="prefabs.php?page=1&amp;per-page=50">50</option>
                            </select>
                        </div>
                    </form>
                </div>
    ...
    <div class="row-fluid">
        <div id="prefab-list" class="col-lg-12">
            <div class="table-responsive">
                <table class="table table-hover">
                    <thead>
                        ...
                        <tbody>
                            <?php $prefabs->fileList('prefabs', 'no', '0', '999999999999'); ?>
                        </tbody>
                    </thead>
                </table>
            </div>
