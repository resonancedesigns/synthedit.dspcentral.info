<div id="content-swapper" class="container-fluid">
    <div class="row-fluid">
        <div class="col-lg-12">
            <h1 class="res-headers">Docs<sub class="sub-button">
                    ...
                    <form action="" class="form-horizontal" style="margin-top: 20px;">
                        <div class="form-group field">
                            ...
                            <select class="pull-right" name="resNum" onchange="window.location.href= this.form.resNum.options[this.form.resNum.selectedIndex].value">
                                <option value="docs.php?page=1&amp;per-page=10">10</option>
                                <option value="docs.php?page=1&amp;per-page=20">20</option>
                                <option value="docs.php?page=1&amp;per-page=30">30</option>
                                <option value="docs.php?page=1&amp;per-page=40">40</option>
                                <option value="docs.php?page=1&amp;per-page=50">50</option>
                            </select>
                        </div>
                    </form>
                </div>
